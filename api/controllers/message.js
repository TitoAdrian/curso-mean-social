...
function probando(req, res){
    res.status(200).send({
        message: 'Hola que tal desde los mensajes privados!'
    });
}
...
module.exports = {
    ...
    getEmmitMessages: getEmmitMessages,
    getUnviewedMessages: getUnviewedMessages,
    setViewedMessages: setViewedMessages
}